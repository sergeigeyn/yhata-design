...
const VARIANTS = [
  ...
  },
  {
    ...
    tag: "Вариант D",
    name: "Provenance",
    desc: "Дневник коллекционера: хронология вещей, история владения, состояние — Letterboxd + Discogs + Aesop",
    bg: "#FAFAF7",
    accent: "#1B6840",
    tagBg: "rgba(27,104,64,0.07)",
    border: "rgba(27,104,64,0.2)",
    strip: "linear-gradient(to right, #1B6840, #4A9A6A)",
    palette: ["#FAFAF7", "#FFFFFF", "#E8E5DF", "#1B6840", "#141410"],
    pBorder: "rgba(0,0,0,0.07)",
    label: "Collector · Diary",
    labelColor: "#AEAAA4",
    isNew: true,
  },
];
